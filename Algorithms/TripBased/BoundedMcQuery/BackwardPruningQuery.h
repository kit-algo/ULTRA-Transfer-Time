...
public:
    ...
    using Type = BackwardPruningQuery<Debug>;
...
public:
    BackwardPruningQuery(const Data& data, const ForwardPruningQuery<Debug>& forwardPruningQuery, const CH::BucketQuery<CHGraph, true, false>& bucketQuery, BoundedProfiler& profiler) :
        data(data),
...
private:
    const Data& data;
    const ForwardPruningQuery<Debug>& forwardPruningQuery;
